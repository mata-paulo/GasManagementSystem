...
const CEBU_BARANGAYS = [
  ...
  "Basak San Nicolas", "Binaliw", "Budlaan", "Buhisan", "Bulacao", "Buot-Taup Pardo",
  "Busay", "Calamba", "Cambinocot", "Camputhaw", "Capitol Site", "Carreta",
  "Central Poblacion", "Cogon Pardo", "Cogon Ramos", "Day-as", "Duljo", "Ermita",
  "Escario", "Guadalupe", "Guba", "Hipodromo", "Inayawan", "Kalubihan",
  "Kalunasan", "Kamagayan", "Kasambagan", "Kinasang-an Pardo", "Labangon",
  "Lahug", "Lorega San Miguel", "Lusaran", "Luz", "Mabini", "Mabolo",
  "Malubog", "Manggis", "Manipis", "Manueva", "Marcelo Fernan", "Mipangi",
  "Monte Fresco", "Nasipit", "Nga-an", "Nivel Hills", "Non-oc", "Odlot",
  "Pari-an", "Paril", "Pasil", "Pit-os", "Poblacion Pardo", "Pulangbato",
  "Pung-ol Sibugay", "Punta Princesa", "Quiot Pardo", "Rahum", "Raim",
  "Ratay", "Ramos", "San Antonio", "San Jose", "San Nicolas Proper",
  "San Roque", "Santa Cruz", "Santa Lucia", "Santo Niño", "Sapangdaku",
  "Sawang Calero", "Señor", "Sibugay", "Sinsin", "Sirao", "Suba Pasil",
  "Suba-basbas", "Sudlon I", "Sudlon II", "T. Padilla", "Tabunan",
  "Tagbao", "Talamban", "Taptap", "Tejero", "Tinago", "Tisa",
  "To-ong Pardo", "Toong", "Tugbongan", "Bulacao", "Zapatera",
];
      ...
      <main className="flex-1 px-6 pt-6 pb-12 max-w-md mx-auto w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="bg-tertiary-fixed/30 border-l-4 border-tertiary p-3 rounded-r-lg flex gap-3 text-xs text-on-tertiary-fixed-variant">
            ...
            A QR code will be generated with your vehicle type, plate number, full name, barangay, and registration timestamp.
          </div>
